let mvdData = [
  {
    question: "На какой высоте размещаются приемные блоки беспроводных извещателей?",
    answers: {
      a: "не менее 2,3м",
      b: "не менее 1,5м",
      c: "не менее 0,7м",
  ...
  {
    question: "С какой периодичностью производится внешний осмотр и проверка работоспособности системы?",
    answers: {
      a: "согласно договору",
