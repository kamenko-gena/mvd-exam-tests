let mvdData = [
  {
    question:
      "На какой высоте размещаются приемные блоки беспроводных извещателей?",
    answers: {
      a: "не менее 2,3м",
      b: "не менее 1,5м",
      c: "не менее 0,7м",
    ...
    description: "п.6.7 ТКП 490-2013",
    correctAnswer: "b",
    userAnswer: null,
  },
  {
    question:
      "С какой периодичностью производится внешний осмотр и проверка работоспособности системы?",
    answers: {
      a: "согласно договору",
      b: "не реже 1 раза в месяц",
      c: "не реже 1 раза в квартал",
      d: "не реже 2 раз в месяц",
    },
  ...
  {
    question:
      "При помощи чего крепятся видеокамеры с техническими средствами наведения к площадкам, стойкам, мачтам?",
    answers: {
  ...
  {
    question:
      "Сколько пикселей на метр должно быть в ТСВ для обнаружения, в том числе распознования событий?",
    answers: {
      a: "не менее 250",
      b: "не менее 100",
      c: "не менее 300",
  ...
  {
    question:
      "Сколько пикселей на метр должно быть в ТСВ для различения, в том числе узнаваемости внешности человека?",
    answers: {
      a: "не менее 100",
      b: "не менее 250",
      c: "не менее 300",
  ...
  {
    question:
      "Сколько пикселей на метр должно быть в ТСВ для идентификациии лиц людей?",
    answers: {
      a: "не менее 100",
      b: "не менее 500",
      c: "не менее 300",
  ...
  {
    question:
      "Сколько пикселей на метр должно быть в ТСВ для идентификациии государственных регистрационных знаков транспортных средств?",
    answers: {
      a: "не менее 100",
      b: "не менее 300",
      c: "не менее 500",
  ...
  {
    question:
      "С какой минимальной частатой кадров технические средства ТСВ должны обеспечивать формирование, передачу и запись видеоизображения?",
    answers: {
  ...
  {
    question:
      "На какое минимальное время резервный источник питания должен обеспечить работу технических средств ТСВ?",
    answers: {
      a: "не менее 3 часов",
      b: "не менее 2 часов",
      c: "не менее 24 часов",
  ...
  {
    question:
      "Какую минимальную разрешающую способность должна иметь видеокамера ТСВ?",
    answers: {
  ...
  {
    question:
      "На какой высоте от пола должны быть установлены органы управления и индикаторы обслуживаемого настенного оборудования?",
    answers: {
      a: "1.0 м",
      b: "1.6 +- 0,1 м",
      c: "2.5 +- 0,5 м",
  ...
  {
    question:
      "На какой высоте от пола должно быть установлено необслуживаемое настенное оборудование?",
    answers: {
  ...
  {
    question:
      "Какое максимальное сопротивление может быть у заземляющего устройства ТСВ?",
    answers: {
      a: "2 Ом",
      b: "4 Ом",
      c: "15.5 Ом",
  ...
  {
    question:
      "В каком диапазоне температур должна обеспечиваться работоспособность технических средств ТСВ расположенных вне отапливаемых или кондиционируемых помещений?",
    answers: {
      a: "от -5 до +50 °С",
      b: "от -30 до +40 °С",
      c: "от -10 до +70 °С",
  ...
  {
    question:
      "С какой периодичностью проводится техническое обслуживание в составе и объеме регламента №1 ?",
    answers: {
      a: "два раза в месяц",
      b: "один раз в месяц",
  ...
  {
    question:
      "После подписания договора на техническое обслуживание, что должен оформить Исполнитель?",
    answers: {
  ...
  {
    question:
      "Кто рассписывается в Журналах регистрации работ по техническому обслуживанию средств и систем охраны?",
    answers: {
  ...
  {
    question:
      "Каким образом осуществляется крепление узлов извещателя на поверхности?",
    answers: {
  ...
  {
    question:
      "Сколько допускается подключать, в один шлейф, объемных извещателей, вибрационных, сейсмических или акустических?",
    answers: {
      a: "не боллее 10",
  ...
  {
    question:
      "Какие требования предъявляются к конструкциям для монтажа объемных охранных извещателей?",
    answers: {
  ...
  {
    question:
      "Резервный источник питания должен обеспечить работу системы охранной сигнализации в 'дежурном режиме' на время ...",
    answers: {
      a: "24 часа",
      b: "12 часов",
  ...
  {
    question:
      "Допускается ли использовать техническое средство охранной сигнализации с нарушенным опломбированием завода-изготовителя?",
    answers: {
  ...
  {
    question:
      "Необходимо ли уведомить территориальное подразделение Департамента охраны о готовности к началу работ перед монтажом системы охранной телевизионной?",
    answers: {
  ...
  {
    question:
      "На какой высоте устанавливаются тревожные ручные извещатели в коридорах по пути транспортирования материальных ценностей?",
    answers: {
  ...
  {
    question:
      "На каком рассотоянии от вертикальной или горизонтальной линии раствора двери устанавливаются магнтоконтактные извещатели?",
    answers: {
      a: "от 300 мм",
      b: "до 200 мм",
  ...
  {
    question:
      "На каком рассотоянии от боковой стороны рамы окна приклеивается омический охранный извещатель типа Фольга?",
    answers: {
      a: "10 - 15 мм",
      b: "2 - 5 мм",
  ...
  {
    question:
      "Между магнитоконтактным извещателем и металлической поверхностью, для повышения работы извещателя, устанавливается...",
    answers: {
  ...
  {
    question:
      "На каком расстоянии устанавливается ППК и элементы управления на охраняемом объекте?",
    answers: {
  ...
  {
    question:
      "Какой тип охранных извещателей не допускается использовать в музеях?",
    answers: {
      a: "омические",
      b: "магнитоконтактные",
  ...
  {
    question:
      "Какой тип охранных извещателей допускается использовать во взрывоопасных зонах при подключении их в искробезопасный шлейф?",
    answers: {
      a: "объемные",
      b: "емкостные",
      c: "радиоволновые",
  ...
  {
    question:
      "Каким крепежным изделием производится крепление корпуса объемных извещателей к опоре?",
    answers: {
      a: "клеем",
      b: "болтами",
...
let gazpromData = [
  ...
  {
    question:
      "Какой документ допускает юридических лиц к оказанию услуг по ТО ИТСО, по договорам?",
    answers: {
  ...
  {
    question:
      "Какой документ создается в филиалах Общества регламентирующий организацию работ то ТО ИТСО?",
    answers: {
  ...
  {
    question:
      "Какой ТКП устанавливает требования к порядку организации и проведения технического обслуживания ИТСО?",
    answers: {
      a: "ТКП 490-2013",
      b: "ТКП 427-2022",
      c: "ТКП 316-2013",
    ...
    description:
      "ТКП 472-2013 «Правила технического обслуживания технических систем охраны»",
    correctAnswer: "d",
    userAnswer: null,
  },
  {
    question:
      "Какой ЛНПА Общества устанавливает порядок организации и проведения работ по ТО ИТСО?",
    answers: {
    ...
    description:
      "СТП СФШИ.02.82-2015 «Руководство по эксплуатации ТСО в ОАО «Газпром трансгаз Беларусь»",
    correctAnswer: "a",
    userAnswer: null,
  },
  {
  ...
  {
    question:
      "Какие различают виды ремонта систем охраны согласно ТКП 472-2013?",
    answers: {
  ...
  {
    question:
      "В каком случаи проводится внеплановый контроль качества ТО ИТСО согласно ТКП 472-2013?",
    answers: {
  ...
  {
    question:
      "С какой периодичностью проводится ТО ИТСО в объеме Регламента № 1 согласно СТП СФШИ.02.82-2015?",
    answers: {
  ...
  {
    question:
      "С какой периодичностью проводится ТО ИТСО в объеме Регламента № 2 согласно СТП СФШИ.02.82-2015?",
    answers: {
  ...
  {
    question:
      "Какие различают этапы проведения пуско-наладочных работ ИТСО согласно СТП СФШИ.02.83-2015?",
    answers: {
  ...
  {
    question:
      "Какие различают уровни безопасности при организации охраны объектов с использованием ИТСО согласно ТКП 627-2018?",
    answers: {
  ...
  {
    question:
      "Необходимо ли блокировать на пролом (выем) строительные конструкции диаметр (ширина и высота) которых меньше 200мм?",
    answers: {
      a: "да",
      b: "нет",
  ...
  {
    question:
      "Каким образом подключаются антисаботажные (темперные) контакты ИТСО к приемно-контрольному прибору?",
    answers: {
  ...
  {
    question:
      "На какие категории подразделяется объекты в зависимости от значимости (важности) и опасности согласно ТКП 627-2018?",
    answers: {
...
function startMvdTests() {
  ...
  title.innerHTML =
    "Проектирование, монтаж, наладка, ТО ИТСО<br>Экзамен МВД</br>";
}
...
function startGazpromTests() {
  ...
  trainingButton.style.display = "inline-block";
  title.innerHTML =
    "Проектирование, монтаж, наладка, ТО ИТСО<br>Техучеба специалистов по ТО ИТСО</br>";
}
